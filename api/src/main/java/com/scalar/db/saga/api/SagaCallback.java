...
public interface SagaCallback {
   ...
   * is still live and still owned by the engine — it resumes when the step reports back, and its
   * eventual outcome arrives on one of the terminal methods above, or through {@link
