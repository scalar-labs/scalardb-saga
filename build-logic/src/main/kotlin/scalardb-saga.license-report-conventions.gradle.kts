...
// :server, whose container image vendors ~230 third-party jars whose licenses and copyright notices
...
// set the value of task ':server:spotlessJava' property 'taskService'"). Routing every external plugin
