...
// The javadoc jar carries a second clock inside its entries, one the archive settings above cannot
// reach: javadoc stamps every generated page with a "Generated by javadoc (21) on <date>" comment
