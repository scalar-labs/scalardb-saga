...
/**
 * The definition store as a reload pass needs it: register a definition, and ask which version of a
 * name actually serves new starts.
 *
...
interface DefinitionStore {
  ...
  /**
   * The version of {@code sagaName} a name-only start would run, or {@code null} when nothing is
   * registered under that name.
   */
  @Nullable String latestVersion(String sagaName);

  /**
   * Whether {@code version} of {@code sagaName} is already stored. With {@link #latestVersion} it
